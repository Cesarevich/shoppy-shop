...
final class ProductsOnSalePostControllerTest extends WebTestCase
{
    #[Test]
    public function it_should_list_a_product(): void
    {
    ...
    #[Test]
    public function it_should_reject_product_list_if_already_listed(): void
    {
        $productId = ProductId::random()->value();
        $typeId = TypeId::random()->value();
        $client = self::createClient();
    ...
    #[Test]
    public function it_should_reject_product_list_if_withdrawn(): void
    {
        $productId = ProductId::random()->value();
        $typeId = TypeId::random()->value();
        $client = self::createClient();
        ...
        $data = json_decode((string) $client->getResponse()->getContent(), true, 512, JSON_THROW_ON_ERROR);
        self::assertSame('product_not_in_draft', $data['error']);
    }
