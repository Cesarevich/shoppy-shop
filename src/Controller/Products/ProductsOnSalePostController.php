...
#[AsController]
final class PutProductsOnSaleController
{
    public function __construct(private readonly CommandBus $commandBus) {}

    //POST {{host}}/products/{{productId}}/list
    #[Route('/products/{id}', name: 'products_put_onSale', methods: ['POST'], requirements: ['id' => Uuid::PATTERN])]
